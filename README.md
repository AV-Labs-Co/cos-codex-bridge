...
If you prefer npm to Git, install a pinned release into a dedicated folder, then run its same local installer. Use `@0.1.3` for stable Codex only or `@0.2.0-beta.1` for Codex plus the Claude Code CLI preview:
